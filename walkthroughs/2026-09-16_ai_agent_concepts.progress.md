...
- [x] §5 + §5.1 + §5.2 Three pillars (with Quiz 3), the MCP bridge, the red-team article — missed — discussed ✓ — accepted: switchboard table, autonomy-and-memory note, MCP intro table; new wiki article three-pillars-of-an-agent. Rejected: red-team article (specifics unverified; the guardrails lesson stands on the escalation example)
